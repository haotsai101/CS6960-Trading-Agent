...
const CLOSED=[{symbol:"META",exit:"2025-12-18",entry:"2025-03-10",pnl:22.4,pnlD:8420,days:283,reason:"Target hit",sector:"Technology",eP:482.30,xP:590.40},{symbol:"TSLA",exit:"2025-11-02",entry:"2025-06-15",pnl:-12.8,pnlD:-4210,days:140,reason:"Stop loss",sector:"Consumer Disc.",eP:248.10,xP:216.30},{symbol:"COST",exit:"2025-10-21",entry:"2025-01-08",pnl:18.7,pnlD:6890,days:286,reason:"Valuation stretch",sector:"Cons. Staples",eP:698.20,xP:828.80},{symbol:"AMD",exit:"2025-09-14",entry:"2025-04-22",pnl:31.2,pnlD:9130,days:145,reason:"Target hit",sector:"Technology",eP:148.40,xP:194.70},{symbol:"PFE",exit:"2025-08-30",entry:"2025-02-18",pnl:-8.4,pnlD:-2180,days:193,reason:"Thesis broken",sector:"Healthcare",eP:28.40,xP:26.02},{symbol:"NFLX",exit:"2025-12-01",entry:"2025-05-20",pnl:16.9,pnlD:5420,days:195,reason:"Target hit",sector:"Comm. Services",eP:648.20,xP:757.80},{symbol:"BA",exit:"2025-07-22",entry:"2025-03-01",pnl:-18.2,pnlD:-6340,days:143,reason:"Stop loss",sector:"Industrials",eP:192.40,xP:157.38},{symbol:"ORCL",exit:"2025-11-15",entry:"2025-06-01",pnl:9.8,pnlD:3120,days:167,reason:"Rebalance",sector:"Technology",eP:128.40,xP:140.98},{symbol:"SHOP",exit:"2025-10-05",entry:"2025-04-12",pnl:27.3,pnlD:7840,days:176,reason:"Target hit",sector:"Technology",eP:68.20,xP:86.82},{symbol:"INTC",exit:"2025-08-15",entry:"2025-05-10",pnl:-24.8,pnlD:-8420,days:97,reason:"Stop loss",sector:"Technology",eP:32.10,xP:24.14}];
const ALERTS=[{cat:"Position Size",sev:"high",msg:"NVDA at 4.2% — approaching 5% hard cap. Trim $8.2K to target 3.5%.",symbol:"NVDA",time:"Now",icon:"◆"},{cat:"Position Size",sev:"med",msg:"AVGO up 42.1% — weight drifted from 1.8% entry to 2.5%.",symbol:"AVGO",time:"Today",icon:"◆"},{cat:"Factor Breach",sev:"high",msg:"Momentum factor at +0.8σ — above 0.6σ threshold.",time:"2h ago",icon:"◇"},{cat:"Factor Breach",sev:"med",msg:"Quality factor at +0.8σ — nearing 1.0σ ceiling.",time:"Today",icon:"◇"},{cat:"Drawdown",sev:"high",msg:"Energy sector −4.1% this week. Approaching −5% review trigger.",time:"Today",icon:"▾"},{cat:"Drawdown",sev:"low",msg:"UNH down 5.4% from cost — not at 8% stop yet.",symbol:"UNH",time:"2d ago",icon:"▾"},{cat:"Correlation",sev:"med",msg:"NVDA–AVGO 90d corr at 0.85 — combined 6.7% weight.",time:"Weekly",icon:"⬡"},{cat:"Correlation",sev:"low",msg:"Tech internal correlation rising: 0.68 avg (was 0.61).",time:"Weekly",icon:"⬡"},{cat:"Earnings",sev:"info",msg:"5 positions reporting next week: MSFT, AMZN, MA, CAT, XOM.",time:"Upcoming",icon:"◈"},{cat:"Earnings",sev:"info",msg:"Fed rate decision Feb 19. Sensitivity: −0.12% per 25bps.",time:"Feb 19",icon:"◈"},{cat:"Macro",sev:"med",msg:"CPI Thursday — 7.3% energy exposure vs 3.7% benchmark.",time:"Feb 12",icon:"◈"}];
// ═══ MANAGER DATA ═══
const TEAMS=[
...
const STRATEGIES=[
  // Alpha Equity
  {id:"s1",teamId:"alpha",name:"Long LLY — GLP-1 Thesis",type:"fundamental",status:"active",positions:1,inception:"2025-02-18",lastRecon:null,reconCount:0,invested:35830,cumRet:24.1,aytdRet:18.2,realized:0,unrealized:6920,symbols:["LLY"]},
  {id:"s2",teamId:"alpha",name:"Long NVDA — AI Capex",type:"fundamental",status:"active",positions:1,inception:"2025-05-12",lastRecon:null,reconCount:0,invested:43490,cumRet:38.2,aytdRet:22.4,realized:0,unrealized:11980,symbols:["NVDA"]},
  {id:"s3",teamId:"alpha",name:"Semiconductor Cycle Play",type:"systematic",status:"active",positions:3,inception:"2025-04-01",lastRecon:"2025-10-01",reconCount:1,invested:62800,cumRet:22.8,aytdRet:14.6,realized:9130,unrealized:8420,symbols:["AVGO","AMAT","PANW"],
  ...
  {id:"s4",teamId:"alpha",name:"Payments Duopoly",type:"fundamental",status:"active",positions:2,inception:"2025-03-20",lastRecon:null,reconCount:0,invested:34100,cumRet:9.8,aytdRet:6.2,realized:0,unrealized:3380,symbols:["MA","V"]},
  {id:"s5",teamId:"alpha",name:"Long META — Reels Monetization",type:"fundamental",status:"inactive",positions:0,inception:"2025-03-10",lastRecon:null,reconCount:0,invested:0,cumRet:22.4,aytdRet:0,realized:8420,unrealized:0,symbols:[]},
  {id:"s6",teamId:"alpha",name:"E-Commerce Recovery",type:"fundamental",status:"active",positions:1,inception:"2025-01-15",lastRecon:null,reconCount:0,invested:29680,cumRet:15.8,aytdRet:10.1,realized:0,unrealized:4060,symbols:["AMZN"]},
  // Quant Systems
  {id:"s7",teamId:"quant",name:"Momentum Top Decile Q4-25",type:"systematic",status:"active",positions:8,inception:"2025-10-01",lastRecon:"2026-01-02",reconCount:1,invested:124000,cumRet:12.4,aytdRet:12.4,realized:4200,unrealized:11200,symbols:["HIMS","SOFI","RKLB","DDOG","GE","CRM","AVGO","AMZN"],
  ...
  {id:"s8",teamId:"quant",name:"Low Vol Quality Screen",type:"systematic",status:"active",positions:6,inception:"2025-07-01",lastRecon:"2026-01-02",reconCount:2,invested:92000,cumRet:6.8,aytdRet:4.2,realized:3120,unrealized:-2800,symbols:["MSFT","JPM","UNH","DHR","CTAS","NEE"],
  ...
  {id:"s9",teamId:"quant",name:"Mean Reversion Basket",type:"systematic",status:"inactive",positions:0,inception:"2025-04-15",lastRecon:null,reconCount:0,invested:0,cumRet:-6.2,aytdRet:0,realized:-4800,unrealized:0,symbols:[]},
  // Macro Themes
  {id:"s10",teamId:"macro",name:"Inflation Hedge — Energy + Commodities",type:"macroeconomic",status:"active",positions:4,inception:"2025-03-01",lastRecon:"2025-11-15",reconCount:2,invested:82400,cumRet:-1.2,aytdRet:-4.8,realized:-6340,unrealized:-2100,symbols:["XOM","SLB","FCX","CAT"],
  ...
  {id:"s11",teamId:"macro",name:"Rate Sensitivity — Financials",type:"macroeconomic",status:"active",positions:2,inception:"2025-06-01",lastRecon:null,reconCount:0,invested:36800,cumRet:12.1,aytdRet:8.4,realized:3680,unrealized:4120,symbols:["JPM","SOFI"]},
  {id:"s12",teamId:"macro",name:"AI Infrastructure Build-Out",type:"macroeconomic",status:"active",positions:3,inception:"2025-05-01",lastRecon:"2025-11-01",reconCount:1,invested:98200,cumRet:28.6,aytdRet:19.2,realized:5420,unrealized:18200,symbols:["NVDA","MSFT","GOOG"],
...
const ALL_POS=[{symbol:"NVDA",name:"NVIDIA",weight:4.2,pnl:38.2,dayChg:1.2,cost:98.42,price:135.87,sector:"Technology",industry:"Semiconductors",days:187,cap:"Large"},{symbol:"MSFT",name:"Microsoft",weight:3.8,pnl:12.4,dayChg:0.3,cost:348.20,price:391.40,sector:"Technology",industry:"Software",days:312,cap:"Large"},{symbol:"LLY",name:"Eli Lilly",weight:3.5,pnl:24.1,dayChg:-0.8,cost:582.10,price:722.30,sector:"Healthcare",industry:"Pharma",days:245,cap:"Large"},{symbol:"JPM",name:"JPMorgan",weight:3.1,pnl:8.7,dayChg:0.5,cost:178.50,price:194.02,sector:"Financials",industry:"Banks",days:198,cap:"Large"},{symbol:"AMZN",name:"Amazon",weight:2.9,pnl:15.8,dayChg:1.8,cost:158.30,price:183.30,sector:"Consumer Disc.",industry:"E-Commerce",days:276,cap:"Large"},{symbol:"XOM",name:"Exxon",weight:2.7,pnl:-3.2,dayChg:-1.1,cost:112.40,price:108.80,sector:"Energy",industry:"Integrated",days:142,cap:"Large"},{symbol:"AVGO",name:"Broadcom",weight:2.5,pnl:42.1,dayChg:2.3,cost:124.80,price:177.30,sector:"Technology",industry:"Semiconductors",days:320,cap:"Large"},{symbol:"UNH",name:"UnitedHealth",weight:2.3,pnl:-5.4,dayChg:-0.2,cost:548.90,price:519.20,sector:"Healthcare",industry:"Managed Care",days:88,cap:"Large"},{symbol:"MA",name:"Mastercard",weight:2.1,pnl:11.3,dayChg:0.1,cost:432.10,price:480.90,sector:"Financials",industry:"Payments",days:201,cap:"Large"},{symbol:"CAT",name:"Caterpillar",weight:1.9,pnl:6.8,dayChg:0.7,cost:318.40,price:340.10,sector:"Industrials",industry:"Machinery",days:156,cap:"Large"},{symbol:"CRM",name:"Salesforce",weight:1.8,pnl:9.2,dayChg:0.4,cost:272.30,price:297.40,sector:"Technology",industry:"Software",days:134,cap:"Large"},{symbol:"AMAT",name:"Applied Mat.",weight:1.7,pnl:18.4,dayChg:1.5,cost:178.90,price:211.80,sector:"Technology",industry:"Semiconductors",days:198,cap:"Large"},{symbol:"DHR",name:"Danaher",weight:1.6,pnl:4.2,dayChg:-0.3,cost:248.10,price:258.50,sector:"Healthcare",industry:"Life Sciences",days:167,cap:"Large"},{symbol:"GE",name:"GE Aero",weight:1.5,pnl:22.8,dayChg:0.9,cost:152.30,price:187.00,sector:"Industrials",industry:"Aerospace",days:234,cap:"Large"},{symbol:"SLB",name:"Schlumberger",weight:1.4,pnl:-7.8,dayChg:-1.4,cost:52.10,price:48.04,sector:"Energy",industry:"Services",days:112,cap:"Large"},{symbol:"MRK",name:"Merck",weight:1.3,pnl:-2.1,dayChg:0.2,cost:118.40,price:115.91,sector:"Healthcare",industry:"Pharma",days:178,cap:"Large"},{symbol:"V",name:"Visa",weight:1.3,pnl:7.4,dayChg:0.3,cost:274.80,price:295.10,sector:"Financials",industry:"Payments",days:189,cap:"Large"},{symbol:"NEE",name:"NextEra",weight:1.2,pnl:3.8,dayChg:0.1,cost:72.40,price:75.15,sector:"Utilities",industry:"Renewables",days:145,cap:"Large"},{symbol:"PANW",name:"Palo Alto",weight:1.1,pnl:14.2,dayChg:0.6,cost:312.40,price:356.80,sector:"Technology",industry:"Cybersecurity",days:98,cap:"Large"},{symbol:"FCX",name:"Freeport",weight:1.0,pnl:-4.1,dayChg:-0.8,cost:44.20,price:42.39,sector:"Materials",industry:"Copper",days:121,cap:"Mid"},{symbol:"DDOG",name:"Datadog",weight:0.9,pnl:16.8,dayChg:1.1,cost:118.20,price:138.05,sector:"Technology",industry:"Software",days:142,cap:"Mid"},{symbol:"ABNB",name:"Airbnb",weight:0.8,pnl:-8.2,dayChg:-1.2,cost:148.30,price:136.14,sector:"Consumer Disc.",industry:"Travel",days:92,cap:"Mid"},{symbol:"HIMS",name:"Hims & Hers",weight:0.6,pnl:52.4,dayChg:3.2,cost:18.40,price:28.04,sector:"Healthcare",industry:"DTC Health",days:156,cap:"Small"},{symbol:"ENPH",name:"Enphase",weight:0.5,pnl:-22.1,dayChg:-2.1,cost:128.40,price:100.02,sector:"Technology",industry:"Solar",days:201,cap:"Mid"},{symbol:"SOFI",name:"SoFi",weight:0.5,pnl:28.4,dayChg:1.8,cost:8.92,price:11.45,sector:"Financials",industry:"Fintech",days:234,cap:"Small"},{symbol:"CELH",name:"Celsius",weight:0.4,pnl:-31.2,dayChg:-0.4,cost:58.10,price:39.97,sector:"Consumer Disc.",industry:"Beverages",days:178,cap:"Small"},{symbol:"RKLB",name:"Rocket Lab",weight:0.3,pnl:68.4,dayChg:4.1,cost:12.80,price:21.56,sector:"Industrials",industry:"Space",days:112,cap:"Small"}];
const SL=[...new Set(ALL_POS.map(p=>p.sector))].sort();
function Stat({label,value,sub,color}){return(<div style={{padding:"12px 14px",background:T.surface,border:`1px solid ${T.border}`,borderRadius:8}}><div style={{fontSize:10,color:T.tM,fontFamily:M,textTransform:"uppercase",letterSpacing:"0.06em",marginBottom:5}}>{label}</div><div style={{fontSize:19,fontWeight:600,color:color||T.text,fontFamily:M,letterSpacing:"-0.02em"}}>{value}</div>{sub&&<div style={{fontSize:11,color:typeof sub==="string"&&sub.startsWith("+")?T.green:typeof sub==="string"&&sub.startsWith("-")?T.red:T.tM,marginTop:3,fontFamily:M}}>{sub}</div>}</div>)}
function Panel({title,subtitle,children,full,accent,right}){return(<div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:10,gridColumn:full?"1/-1":undefined,overflow:"hidden",boxShadow:"0 1px 3px rgba(0,0,0,0.03)"}}><div style={{padding:"11px 16px",borderBottom:`1px solid ${T.bLt}`,display:"flex",justifyContent:"space-between",alignItems:"center"}}><div style={{display:"flex",alignItems:"baseline",gap:8}}>{accent&&<div style={{width:3,height:13,borderRadius:2,background:accent}}/>}<span style={{fontSize:13,fontWeight:600,color:T.text,fontFamily:S}}>{title}</span>{subtitle&&<span style={{fontSize:11,color:T.tM,fontFamily:M}}>{subtitle}</span>}</div>{right}</div><div style={{padding:"12px 16px"}}>{children}</div></div>)}
function Tog({opts,value,onChange}){return(<div style={{display:"flex",background:T.sAlt,borderRadius:6,padding:2,border:`1px solid ${T.bLt}`}}>{opts.map(o=>(<button key={o.v} onClick={()=>onChange(o.v)} style={{padding:"3px 10px",borderRadius:4,border:"none",cursor:"pointer",background:value===o.v?T.surface:"transparent",color:value===o.v?T.text:T.tM,fontSize:11,fontFamily:S,fontWeight:value===o.v?600:400,boxShadow:value===o.v?"0 1px 2px rgba(0,0,0,0.06)":"none"}}>{o.l}</button>))}</div>)}
const CTip=({active,payload,label})=>{if(!active||!payload?.length)return null;return(<div style={{background:"#fff",border:`1px solid ${T.border}`,borderRadius:6,padding:"8px 12px",boxShadow:"0 4px 12px rgba(0,0,0,0.08)",fontSize:11,fontFamily:M}}><div style={{color:T.tS,marginBottom:4}}>{label}</div>{payload.map((p,i)=>(<div key={i} style={{color:p.color,display:"flex",justifyContent:"space-between",gap:16}}><span>{p.name}</span><span style={{fontWeight:600}}>{typeof p.value==="number"?p.value.toFixed(1):p.value}</span></div>))}</div>)};
...
return(<div style={{display:"flex",flexWrap:"wrap",gap:2,minHeight:240}}>{Object.entries(g).sort((a,b)=>b[1].w-a[1].w).map(([sn,sec])=>{const sp=(sec.w/tw)*100;return(<div key={sn} style={{width:`calc(${sp}% - 2px)`,minWidth:50,display:"flex",flexDirection:"column",gap:1}}><div style={{fontSize:8,fontFamily:M,color:T.tM,padding:"1px 3px",textTransform:"uppercase",letterSpacing:".04em",overflow:"hidden",whiteSpace:"nowrap"}}>{sn}</div><div style={{display:"flex",flexWrap:"wrap",gap:1,flex:1}}>{sec.items.sort((a,b)=>b.w-a.w).map(it=>{const pct=(it.w/sec.w)*100;const c=it[k];return(<div key={it.t} style={{width:`calc(${pct}% - 1px)`,minWidth:36,minHeight:34,background:gc(c),borderRadius:3,padding:"2px 3px",display:"flex",flexDirection:"column",justifyContent:"space-between"}} title={`${it.t} | ${it.i} | Wt:${it.w}% | ${mode==="day"?"Day":"Wk"}:${pp(c)}${c}%`}><div style={{fontSize:9,fontWeight:700,color:"#fff",fontFamily:M}}>{it.t}</div><div style={{fontSize:8,color:"rgba(255,255,255,.8)",fontFamily:M}}>{pp(c)}{c.toFixed(1)}%</div></div>)})}</div></div>)})}</div>)}
...
const[whatIf,setWhatIf]=useState([{symbol:"",action:"Buy",amount:"5000"}]),[closedV,setClosedV]=useState("table"),[alertCat,setAlertCat]=useState("");
...
const SH=({label,k,align})=>(<th onClick={()=>handleSort(k)} style={{padding:"5px 6px",textAlign:align||"left",fontSize:9,color:sortK===k?T.accent:T.tM,fontFamily:M,fontWeight:500,textTransform:"uppercase",cursor:"pointer",userSelect:"none"}}>{label}{sortK===k&&<span style={{fontSize:7,marginLeft:1}}>{sortD==="desc"?"▼":"▲"}</span>}</th>);
return(<div style={{background:T.bg,minHeight:"100vh",fontFamily:S,color:T.text}}>
...
<div style={{display:"flex",alignItems:"center",gap:12}}><span style={{fontSize:18,fontWeight:700,fontFamily:SE,letterSpacing:"-.03em"}}>Meridian</span><div style={{width:1,height:16,background:T.border}}/><span style={{fontSize:10,color:T.tM,fontFamily:M}}>Equity Portfolio</span></div>
<div style={{display:"flex",alignItems:"center",gap:12}}><span style={{fontSize:10,color:T.tM,fontFamily:M}}>{new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}</span><div style={{padding:"3px 8px",borderRadius:4,fontSize:11,fontFamily:M,fontWeight:600,background:T.gLt,color:T.green}}>{pp(PF.dayPct)}{PF.dayPct}%</div></div>
</header>
<nav style={{background:T.surface,borderBottom:`1px solid ${T.border}`,padding:"0 24px",display:"flex"}}>{TABS.map(t=>(<button key={t.id} onClick={()=>setTab(t.id)} style={{padding:"9px 14px",background:"none",border:"none",cursor:"pointer",borderBottom:tab===t.id?`2px solid ${T.accent}`:"2px solid transparent",color:tab===t.id?T.text:T.tM,fontSize:12,fontFamily:S,fontWeight:tab===t.id?600:400}}>{t.l}</button>))}</nav>
...
<Panel title="Portfolio Heatmap" subtitle="Sector → Industry → Symbol" full accent={T.accent} right={<Tog opts={[{v:"day",l:"Daily"},{v:"week",l:"Weekly"}]} value={heatM} onChange={setHeatM}/>}>
...
<input value={w.symbol} onChange={e=>{const n=[...whatIf];n[i].symbol=e.target.value;setWhatIf(n)}} placeholder="Symbol" style={{padding:"4px 7px",borderRadius:4,border:`1px solid ${T.border}`,fontSize:11,fontFamily:M,width:65,textTransform:"uppercase"}}/>
...
<button onClick={()=>setWhatIf([...whatIf,{symbol:"",action:"Buy",amount:"5000"}])} style={{alignSelf:"flex-start",padding:"4px 10px",borderRadius:4,border:`1px dashed ${T.border}`,background:"none",color:T.accent,fontSize:10,fontFamily:S,cursor:"pointer"}}>+ Add trade</button>
</div>
...
<SH label="Symbol" k="symbol"/><th style={{padding:"5px 6px",fontSize:9,color:T.tM,fontFamily:M,fontWeight:500,textTransform:"uppercase",textAlign:"left"}}>Name</th>
...
<td style={{padding:"5px 6px",fontFamily:M,fontWeight:600,fontSize:11}}>{p.symbol}</td>
...
<thead style={{position:"sticky",top:0,background:T.surface}}><tr style={{borderBottom:`1px solid ${T.border}`}}>{["Symbol","Sector","Entry","Exit","Entry$","Exit$","Ret","P&L","Hold","Reason"].map((h,i)=><th key={i} style={{padding:"5px 6px",textAlign:i>=2?"right":"left",fontSize:9,color:T.tM,fontFamily:M,fontWeight:500,textTransform:"uppercase"}}>{h}</th>)}</tr></thead>
...
<td style={{padding:"5px 6px",fontFamily:M,fontWeight:600}}>{p.symbol}</td><td style={{padding:"5px 6px",color:T.tM,fontSize:10}}>{p.sector}</td>
...
<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
<div><div style={{fontSize:11,fontWeight:600,color:T.tS,marginBottom:6}}>Returns</div><ResponsiveContainer width="100%" height={150}><BarChart data={CLOSED.sort((a,b)=>b.pnl-a.pnl)} margin={{top:4,right:4,bottom:0,left:0}}><XAxis dataKey="symbol" tick={{fontSize:9,fill:T.tM,fontFamily:M}} axisLine={false} tickLine={false}/><YAxis tick={{fontSize:9,fill:T.tM,fontFamily:M}} axisLine={false} tickLine={false} tickFormatter={v=>`${v}%`}/><Tooltip content={<CTip/>}/><ReferenceLine y={0} stroke={T.border}/><Bar dataKey="pnl" name="Ret" radius={[3,3,0,0]}>{CLOSED.sort((a,b)=>b.pnl-a.pnl).map((c,i)=><Cell key={i} fill={c.pnl>=0?T.green:T.red} opacity={.6}/>)}</Bar></BarChart></ResponsiveContainer></div>
...
{a.symbol&&<div style={{marginTop:3}}><span style={{fontSize:10,fontFamily:M,fontWeight:600,padding:"1px 5px",borderRadius:3,background:T.aLt,color:T.accent}}>{a.symbol}</span></div>}
</div></div>))}
</div></Panel>
...
{selStratData.symbols.length>0?(<div style={{display:"flex",flexWrap:"wrap",gap:4}}>{selStratData.symbols.map(t=>{const p=ALL_POS.find(x=>x.symbol===t);return(<div key={t} style={{padding:"5px 8px",background:T.sAlt,borderRadius:5,border:`1px solid ${T.bLt}`}}>
